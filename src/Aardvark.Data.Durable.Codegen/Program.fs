...
let main argv =
    ...
    //let address = @"https://raw.githubusercontent.com/aardvark-platform/aardvark.data.durable.definitions/master/definitions.json"
    //let wc = new WebClient()
    //let json = JObject.Parse(wc.DownloadString(address))

    let json = JObject.Parse(File.ReadAllText(@"C:\Data\Development\aardvark.data.durable.definitions\definitions.json"))
